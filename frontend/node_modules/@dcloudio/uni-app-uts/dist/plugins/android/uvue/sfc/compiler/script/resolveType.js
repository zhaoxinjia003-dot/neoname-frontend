            ...
            case 'TSTypeReference': {
                ...
                if (resolved) {
                    if (node.typeName.type === 'Identifier' &&
                        ...
                        return [
                            `Object as PropType<${scope.source.slice(node.start + scope.offset, node.end + scope.offset)}>`,
                        ];
                    }
                ...
                if (node.typeName.type === 'Identifier') {
                    if (node.typeName.name === 'Array') {
                        return [
                            `Array as PropType<${scope.source.slice(node.start + scope.offset, node.end + scope.offset)}>`,
                        ];
                    }
                    return [
